...
public class OI {
    ...
    public JoystickButton armGrabberButton;
    ...
    public OI() {
        ...
        armGrabberButton = new JoystickButton(joystickOperator, 1);
        armGrabberButton.whenPressed(new ArmGrabButton());
        ...
        SmartDashboard.putData("LiftGeneric", new LiftGeneric());

        SmartDashboard.putData("TankDrive", new TankDrive());

        SmartDashboard.putData("ArmGrabButton", new ArmGrabButton());
