    ...
    protected void initialize() {
    	thread = new Thread(new Runnable() {
			...
			public void run() {
				...
				while (RobotMap.driveTrainDriveEncoderLeft.getDistance() > -15.0) RobotMap.driveTrainRobotDrive.tankDrive(0.5, 0.5);
        		...
        		RobotMap.driveTrainDriveEncoderLeft.reset();
        		RobotMap.driveTrainDriveEncoderRight.reset();
				while (RobotMap.driveTrainDriveEncoderLeft.getDistance() < 500.0) RobotMap.driveTrainRobotDrive.tankDrive(-0.6, -0.6);
		    	RobotMap.driveTrainRobotDrive.tankDrive(0.0,  0.0);
